...
размер ЕЩЕ сильнее снизился : в 10.7 раз/ 9.4 раза по сравнению с изначальным сырым образом.
...
| Image Name          | Image ID       | Size   | Virtual Size |
|---------------------|----------------|--------|--------------|
| `mynginx:alpine`    | 835d06112403   | 25.1MB | 9.1MB        |
| `mynginx:clean`     | 36ae032903b6   | 269MB  | 85.7MB       |
| `mynginx:few`       | f5f1e8d3b8b1   | 164MB  | 43MB         |
| `mynginx:minx`      | 52011c19ccb2   | 19.2MB | 6.19MB       |
| `mynginx:raw`       | fa15b3487db2   | 269MB  | 85.7MB       |
| `mynginx:repack`    | c3a7739be29d   | 234MB  | 77MB         |
...
перепаковка образ это создание нового образа из текущего состояния контейнера (export -> import), когда все слои объединяются в один, история слоёв исчезает, но мусор не удаляется автоматически